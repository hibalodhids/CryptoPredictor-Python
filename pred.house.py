...
new_house = np.array([[1500, 4, 5]])  # Area, Bedrooms, Age
predicted_price = model.predict(new_house)
print("\n💡 Predicted Price for 1500 sqft, 4-bed, 15-year old house:", predicted_price[0])

plt.scatter(df['Bedrooms'], df['Price'], color='blue', label='Actual Price')
